...
export class Init1691148305288 implements MigrationInterface {
  name = 'Init1691148305288';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "album-fav" ("id" SERIAL NOT NULL, "albumId" uuid, CONSTRAINT "REL_3dfad60b6e7e20f210ee549081" UNIQUE ("albumId"), CONSTRAINT "PK_1d5e7fc32041e8818e2666d29ec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "artist-fav" ("id" SERIAL NOT NULL, "artistId" uuid, CONSTRAINT "REL_fbd0effda2c010ffc44e2dd41f" UNIQUE ("artistId"), CONSTRAINT "PK_408c2feebcb4c4909999f217c2a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "track-fav" ("id" SERIAL NOT NULL, "trackId" uuid, CONSTRAINT "REL_1076fb71a25ea513d08cc7f11b" UNIQUE ("trackId"), CONSTRAINT "PK_db145e07251886cb8a6fa09f1a0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "album-fav" ADD CONSTRAINT "FK_3dfad60b6e7e20f210ee5490812" FOREIGN KEY ("albumId") REFERENCES "album"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "artist-fav" ADD CONSTRAINT "FK_fbd0effda2c010ffc44e2dd41fc" FOREIGN KEY ("artistId") REFERENCES "artist"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "track-fav" ADD CONSTRAINT "FK_1076fb71a25ea513d08cc7f11be" FOREIGN KEY ("trackId") REFERENCES "track"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "track-fav" DROP CONSTRAINT "FK_1076fb71a25ea513d08cc7f11be"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "artist-fav" DROP CONSTRAINT "FK_fbd0effda2c010ffc44e2dd41fc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "album-fav" DROP CONSTRAINT "FK_3dfad60b6e7e20f210ee5490812"`,
    );
    await queryRunner.query(
